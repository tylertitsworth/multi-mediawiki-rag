# Contributing to multi-mediawiki-rag
...
3. Install [pre-commit](https://pre-commit.com/), [Docker](https://docs.docker.com/engine/install/), and [Node.js](https://nodejs.org/en/download).
